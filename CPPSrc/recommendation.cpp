      ...
      m_playlistTracksRequester(10000, this), m_lazyRequester(10000, this)
{
    ...
    connect(
        &m_playlistTracksRequester, &HttpGetRequester::requestTimeout, this, [this]() { onPlaylistTracksFailed(); }
    );
    connect(
        &m_lazyRequester, &HttpGetRequester::requestFailed, this, [this](const QString &) { onLazyTracksFailed(); }
    );
    connect(&m_lazyRequester, &HttpGetRequester::requestTimeout, this, [this]() { onLazyTracksFailed(); });
}
...
QVariantList Recommendation::getTopSongsQml() const
{
    return m_topSongs;
}
QVariantList Recommendation::getTopPlaylistsQml() const
{
